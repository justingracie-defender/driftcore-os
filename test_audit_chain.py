...
def reset_audit():
    ...
    try:
        ...
        pass
    try:
        os.remove(os.path.join(os.environ.get("DRIFTCORE_LOG_DIR","logs"),"CHAIN_SHUTDOWN_REASON.json"))
    except Exception:
        pass
...
check("chain shutdown record written",
      os.path.exists(os.path.join(os.environ.get("DRIFTCORE_LOG_DIR","logs"),"CHAIN_SHUTDOWN_REASON.json")))
