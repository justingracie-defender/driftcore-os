...
def _prod(**kw):
    ...
    kw.setdefault("policy_snapshot", PolicySnapshot({"deployment": "halt-test", "revision": 1}))
    ...
    kw.setdefault("human_approval", _prod_approval)
