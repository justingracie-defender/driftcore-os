# DriftCore OS — Documents

This folder contains supporting documents for DriftCore OS.
Update these when the code evolves so they stay accurate.

## Documents

**DriftCore_Manifesto.docx**
The vision and values behind DriftCore. Start here.
Written by Justin Gracie. For the future. For the kids.
...
Anyone contributing to the repo. If you change a module,
